...
export const fillBlankQuestions: Question[] = [
  ...
  },
  {
    ...
    options: {
      ru: ["типизированный", "унифицированный", "абстрактный", "обобщённый"],
      en: ["typed", "unified", "abstract", "generic"],
    },
    correctIndex: 1,
    explanation: {
      ru: "Фасад предоставляет именно унифицированный интерфейс, объединяющий разрозненные интерфейсы подсистемы в одну точку доступа. «Типизированный», «абстрактный» и «обобщённый» не отражают объединяющую роль фасада.",
      en: "Facade provides a unified interface that consolidates the subsystem's separate interfaces into a single access point. \"Typed\", \"abstract\", and \"generic\" fail to capture the unifying role.",
    },
    conceptId: "facade",
  },
  {
  ...
  },
  {
    ...
    options: {
      ru: ["развязки", "связанности", "дублирования", "шаблонного кода"],
      en: ["decoupling", "coupling", "duplication", "boilerplate"],
    },
    correctIndex: 0,
    explanation: {
      ...
      en: "Decoupling is one of the two core justifications for an abstraction alongside hiding details: reducing dependencies between components is what can outweigh the cost of the extra layer. Coupling, duplication, and boilerplate are costs an abstraction should reduce, not benefits it provides.",
    },
