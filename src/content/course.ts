...
/**
 * The single guided Junior→Lead path: all 59 concepts, grouped by grade in
...
export const COURSE: { grade: Grade; conceptIds: string[] }[] = [
  ...
  { grade: 'senior', conceptIds: ['abstract-factory', 'bridge', 'flyweight', 'state', 'interpreter', 'mediator', 'visitor', 'hexagonal', 'clean-architecture', 'event-driven', 'abstraction-cost', 'yagni-vs-flexibility', 'bff', 'saga', 'cqrs', 'anti-corruption-layer', 'aggregator', 'bulkhead', 'sidecar', 'consistency-models', 'quorum', 'partitioning', 'replication'] },
