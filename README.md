...
- **Interview** — an adaptive mock technical interview: difficulty climbs from junior as you answer correctly and stops once it finds your ceiling. Feedback is held until the end, which delivers a grade verdict, a per-level breakdown, and weak topics linking back into Learn. An optional **system-design round** can follow the questions — build a diagram for a grade-matched scenario, scored as a separate section in the report.
